...
export default function TranslationMode() {
  ...
  }, [current, batchManagement.batch?.direction]);
      ...
      <div className="w-full max-w-6xl mx-auto px-4 py-8 md:px-8 md:py-12 lg:px-12 lg:py-16 animate-fade-in">
        ...
        <div className="flex items-center justify-between mb-8 md:mb-12">
          <div className="flex items-center gap-4">
            <a 
              href="/" 
              className="text-[var(--mindaro)] hover:text-[var(--emerald)] transition-colors duration-200 flex items-center gap-2 group"
            >
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-white">Translation Mode</h1>
        </div>
